...
class ScrollableScreenshotWrapper extends StatefulWidget {
  final Widget child;
  final String? screenName;

  const ScrollableScreenshotWrapper({
    super.key,
    required this.child,
    this.screenName,
  });
  ...
  @override
  State<ScrollableScreenshotWrapper> createState() =>
      _ScrollableScreenshotWrapperState();
}

class _ScrollableScreenshotWrapperState
    extends State<ScrollableScreenshotWrapper> {
      ...
      children: [
        ...
        Positioned(
          ...
          child: FloatingActionButton.small(
            heroTag: "scrollable_screenshot_fab",
        ...
        Positioned(
          ...
          right: 80,
          child: FloatingActionButton.small(
            heroTag: "scrollable_gallery_fab",
