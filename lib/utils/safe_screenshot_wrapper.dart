...
class SafeScreenshotWrapper extends StatefulWidget {
  final Widget child;
  final String? screenName;

  const SafeScreenshotWrapper({
    super.key,
    required this.child,
    this.screenName,
  });
  ...
  @override
  State<SafeScreenshotWrapper> createState() => _SafeScreenshotWrapperState();
}

class _SafeScreenshotWrapperState extends State<SafeScreenshotWrapper> {
